...
struct SearchResult
    ...
    videoId::Union{String, Nothing}
    browseId::Union{String, Nothing}
    artist::Union{String, Nothing}
    artistId::Union{String, Nothing}
    album::Union{String, Nothing}
    albumId::Union{String, Nothing}
    duration::Union{String, Nothing}
    thumbnail::Union{String, Nothing}
end
```
...
struct Song
    ...
    lengthSeconds::Union{String, Nothing}
    viewCount::Union{String, Nothing}
    thumbnail::Union{String, Nothing}
    playabilityStatus::Union{String, Nothing}
    isPlayable::Bool
    category::Union{String, Nothing}
    publishDate::Union{String, Nothing}
    uploadDate::Union{String, Nothing}
end
```
...
struct Album
    ...
    trackCount::Union{Int, Nothing}
    duration::Union{String, Nothing}
    thumbnail::Union{String, Nothing}
    description::Union{String, Nothing}
    audioPlaylistId::Union{String, Nothing}
    tracks::Vector{Track}
end
```
...
struct Artist
    ...
    description::Union{String, Nothing}
    thumbnail::Union{String, Nothing}
    subscribers::Union{String, Nothing}
...
struct WatchPlaylist
    playlistId::Union{String, Nothing}
    tracks::Vector{PlaylistTrack}
    lyricsId::Union{String, Nothing}
end
```
...
struct LibraryItem
    ...
    duration::Union{String, Nothing}
    thumbnail::Union{String, Nothing}
    likeStatus::Union{String, Nothing}
end
```
